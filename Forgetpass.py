                    ...
                    def verify_otp():
                        ...
                        if otp1 == OTP:
                            ...
                            heading = Label(signup_window, text='RESET YOUR ACCOUNT PASSWORD',
                                            font=('Microsoft Yahei UI Light', 13, 'bold', 'underline'),
                                            bg='white', fg='black')
                            heading.place(x=870 + 120, y=170)

                            user_name_data = Label(signup_window, font=('', 12),
                                                   text=f'YOUR USER NAME IS: {user_name1}', bg='white', fg='black')
                            user_name_data.place(x=870 + 120, y=220)

                            passwordEntry = Entry(signup_window, font=('', 12), width=35, bd=0, bg='white', fg='gray50')
                            passwordEntry.place(x=850 + 140, y=260 + 20)
                            passwordEntry.insert(0, 'Password')
                            passwordEntry.bind('<FocusIn>', password_enter)

                            Frame(signup_window, width=211.5, height=2, bg='black').place(x=850 + 140, y=275 + 2 + 20)

                            hideButton = Button(signup_window, image=close_eye, bd=0, bg='white', fg='gray50'
                                                , cursor='hand2', command=hide)
                            hideButton.place(x=1070 + 140, y=255 + 20)

                            confirmpasswordEntry = Entry(signup_window, font=('', 12), width=35, bd=0, bg='white',
                                                         fg='gray50')
                            confirmpasswordEntry.place(x=850 + 140, y=320 + 20)
                            confirmpasswordEntry.insert(0, 'confirm Password')
                            confirmpasswordEntry.bind('<FocusIn>', confirmpassword_enter)

                            Frame(signup_window, width=211.5, height=2, bg='black').place(x=850 + 140, y=335 + 2 + 20)

                            hideButton1 = Button(signup_window, image=close_eye, bd=0, bg='white', fg='gray50'
                                                 , cursor='hand2', command=hide1)
                            hideButton1.place(x=1070 + 140, y=315 + 20)

                            signupButton = Button(signup_window, text='CONFORM', font=(0), bd=1, bg='red', fg='white',
                                                  width=20
                                                  , cursor='hand2', command=connect_database)
                            signupButton.place(x=890 + 120, y=400 + 20)
